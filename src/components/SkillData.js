const skillData = [
    ...
    // Technical Fields
    {
      ...
      description: () => (
        <>
          <p>
            Specialized knowledge in computational geometry algorithms and data structures. Experience
            with geometric problem solving, spatial data structures, and geometric algorithms.
          </p>
          <p>
            Implemented solutions for problems including convex hulls, Delaunay triangulations,
            Voronoi diagrams, and geometric intersection detection.
          </p>
        </>
      ),
      relatedProjects: ["Geometric Algorithm Implementation", "Spatial Data Analysis Tool"]
    },
    {
      id: 11,
